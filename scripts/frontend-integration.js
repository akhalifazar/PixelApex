 ...
 * This file demonstrates how to integrate Pixelapex with a web frontend
 */

// For React/Vue/Angular applications
export class PixelapexClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PixelapexClient(provider, contractAddress);
